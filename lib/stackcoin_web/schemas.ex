defmodule StackCoinWeb.Schemas do
  ...
  # Event schemas (TransferCompletedData, TransferCompletedEvent, RequestCreatedData,
  # RequestCreatedEvent, etc., plus Event union and EventsResponse) are generated by
  # the defevent macro in StackCoin.Core.EventData.
